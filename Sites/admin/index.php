...
<td align='center' width='50%'><font color='000ff0'><a href='./delete.php'>Delete</a></font></td>
</tr>
</table>
<br>
...
while($rs2=mysql_fetch_array($result2)) {
	if($rs2[enable]=="y") {
		$rs2[enable]="<font color='0000FF'>$rs2[enable]</font>";
	} else {
		$rs2[enable]="<font color='FF0000'>$rs2[enable]</font>";
	}

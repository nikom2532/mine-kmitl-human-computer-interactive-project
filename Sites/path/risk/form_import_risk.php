...
<br><br><br><br>
<form action="CSV_risk.php" method="post" enctype="multipart/form-data" name="form3">
<table align="left">
<tr>
<td><h2>Form Import Risk.csv File</h2></td>
</tr>
<tr>
<td align="right">INSERT Risk.CSV FILE :</td>

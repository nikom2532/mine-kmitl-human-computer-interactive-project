...
<form action="CSV_audit.php" method="post" enctype="multipart/form-data" name="form1">
<table align="left">
<tr>
<td><h2>Form Import Audit.csv File</h2></td>
</tr>
<tr>
<td align="right">INSERT Audit.CSV FILE :</td>
